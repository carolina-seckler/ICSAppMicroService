...
using SendGrid;
using ICSApp.IS4.Shared.Configuration.Email;
using ICSApp.IS4.Shared.Email;
using ICSApp.IS4.STS.Identity.Configuration;
using ICSApp.IS4.STS.Identity.Configuration.ApplicationParts;
using ICSApp.IS4.STS.Identity.Configuration.Constants;
using ICSApp.IS4.STS.Identity.Configuration.Interfaces;
using ICSApp.IS4.STS.Identity.Helpers.Localization;
using System.Linq;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using ICSApp.IS4.Admin.EntityFramework.MySql.Extensions;
using ICSApp.IS4.Admin.EntityFramework.PostgreSQL.Extensions;
using ICSApp.IS4.Admin.EntityFramework.Shared.Configuration;
using ICSApp.IS4.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;
using Microsoft.AspNetCore.DataProtection.EntityFrameworkCore;
using Microsoft.AspNetCore.Http;
using ICSApp.IS4.Shared.Authentication;
